...
We ran n=150 adults. After exclusion criteria, we retained n=`r n.adults`: n=`r n.adults.condition$n[1]` in the generic condition, n=`r n.adults.condition$n[2]` in the formal explanation condition, and n=`r n.adults.condition$n[3]` in the specific control condition. 
...
df.subj <- df.tidy %>% 
  group_by(participant, condition, measure) %>% 
...
ggplot(df.subj, aes(x = measure, y = response, fill = condition, color = condition)) +
  ...
  stat_summary(fun.y = "mean",
               ...
               color = "black",
               size = 4) 
ggsave("formex_kindEssentialism_subj.png", width = 8, height = 5)
...
ggplot(df.tidy, aes(x = measure, y = response, fill = condition, color = condition)) +
  ...
  stat_summary(fun.y = "mean",
               ...
               color = "black",
               size = 4) 
ggsave("formex_kindEssentialism.png", width = 8, height = 5)
```
